...
static int j20s_36_02_0a_dsc_on(struct j20s_36_02_0a_dsc *ctx)
{
	...
	dsi_dcs_write_seq(dsi, 0x4e, 0x30);
	dsi_dcs_write_seq(dsi, 0x4f, 0x30);
	dsi_dcs_write_seq(dsi, MIPI_DCS_WRITE_CONTROL_DISPLAY, 0x30);
	dsi_dcs_write_seq(dsi, 0x7a, 0x01);
	dsi_dcs_write_seq(dsi, 0x7b, 0x8c);
	dsi_dcs_write_seq(dsi, 0x7d, 0x05);
	dsi_dcs_write_seq(dsi, 0x80, 0x05);
	dsi_dcs_write_seq(dsi, 0x81, 0x05);
	dsi_dcs_write_seq(dsi, 0xa0, 0x0c);
	dsi_dcs_write_seq(dsi, MIPI_DCS_READ_PPS_START, 0x0c);
	dsi_dcs_write_seq(dsi, 0xa3, 0x01);
	dsi_dcs_write_seq(dsi, 0xa4, 0x05);
	dsi_dcs_write_seq(dsi, 0xa5, 0x05);
	...
	dsi_dcs_write_seq(dsi, 0xf1, 0x04);
	dsi_dcs_write_seq(dsi, 0xff, 0x2b);
	dsi_dcs_write_seq(dsi, 0xfb, 0x01);
	dsi_dcs_write_seq(dsi, 0xb7, 0x08);
	dsi_dcs_write_seq(dsi, 0xb8, 0x1a);
	...
	dsi_dcs_write_seq(dsi, 0x09, 0x45);
	...
	dsi_dcs_write_seq(dsi, 0x29, 0x0a);
	dsi_dcs_write_seq(dsi, MIPI_DCS_SET_PARTIAL_ROWS, 0xff);
	dsi_dcs_write_seq(dsi, MIPI_DCS_SET_PARTIAL_COLUMNS, 0xfe);
	dsi_dcs_write_seq(dsi, 0x32, 0xfd);
	dsi_dcs_write_seq(dsi, 0x33, 0xfb);
	dsi_dcs_write_seq(dsi, 0x34, 0xf8);
	dsi_dcs_write_seq(dsi, 0x35, 0xf5);
	dsi_dcs_write_seq(dsi, MIPI_DCS_SET_ADDRESS_MODE, 0xf3);
	dsi_dcs_write_seq(dsi, 0x37, 0xf2);
	dsi_dcs_write_seq(dsi, 0x38, 0xf2);
	dsi_dcs_write_seq(dsi, 0x39, 0xf2);
	...
	dsi_dcs_write_seq(dsi, MIPI_DCS_SET_3D_CONTROL, 0xe9);
	dsi_dcs_write_seq(dsi, 0x3f, 0xe5);
	dsi_dcs_write_seq(dsi, MIPI_DCS_SET_VSYNC_TIMING, 0xe5);
	dsi_dcs_write_seq(dsi, 0x41, 0xe5);
	dsi_dcs_write_seq(dsi, 0x2a, 0x13);
	dsi_dcs_write_seq(dsi, MIPI_DCS_GET_SCANLINE, 0xff);
	dsi_dcs_write_seq(dsi, 0x46, 0xf4);
	dsi_dcs_write_seq(dsi, 0x47, 0xe7);
	dsi_dcs_write_seq(dsi, 0x48, 0xda);
	dsi_dcs_write_seq(dsi, 0x49, 0xcd);
	dsi_dcs_write_seq(dsi, 0x4a, 0xc0);
	dsi_dcs_write_seq(dsi, 0x4b, 0xb3);
	dsi_dcs_write_seq(dsi, 0x4c, 0xb2);
	dsi_dcs_write_seq(dsi, 0x4d, 0xb2);
	dsi_dcs_write_seq(dsi, 0x4e, 0xb2);
	dsi_dcs_write_seq(dsi, 0x4f, 0x99);
	dsi_dcs_write_seq(dsi, 0x50, 0x80);
	...
	dsi_dcs_write_seq(dsi, 0x52, 0x66);
	dsi_dcs_write_seq(dsi, MIPI_DCS_WRITE_CONTROL_DISPLAY, 0x66);
	dsi_dcs_write_seq(dsi, 0x54, 0x66);
	dsi_dcs_write_seq(dsi, 0x2b, 0x0e);
	dsi_dcs_write_seq(dsi, 0x58, 0xff);
	dsi_dcs_write_seq(dsi, 0x59, 0xfb);
	dsi_dcs_write_seq(dsi, 0x5a, 0xf7);
	dsi_dcs_write_seq(dsi, 0x5b, 0xf3);
	dsi_dcs_write_seq(dsi, 0x5c, 0xef);
	dsi_dcs_write_seq(dsi, 0x5d, 0xe3);
	dsi_dcs_write_seq(dsi, MIPI_DCS_SET_CABC_MIN_BRIGHTNESS, 0xda);
	dsi_dcs_write_seq(dsi, 0x5f, 0xd8);
	dsi_dcs_write_seq(dsi, 0x60, 0xd8);
	dsi_dcs_write_seq(dsi, 0x61, 0xd8);
	dsi_dcs_write_seq(dsi, 0x62, 0xcb);
	dsi_dcs_write_seq(dsi, 0x63, 0xbf);
	dsi_dcs_write_seq(dsi, 0x64, 0xb3);
	dsi_dcs_write_seq(dsi, 0x65, 0xb2);
	dsi_dcs_write_seq(dsi, 0x66, 0xb2);
	dsi_dcs_write_seq(dsi, 0x67, 0xb2);
	dsi_dcs_write_seq(dsi, 0xff, 0x27);
	dsi_dcs_write_seq(dsi, 0xfb, 0x01);
	dsi_dcs_write_seq(dsi, MIPI_DCS_SET_VSYNC_TIMING, 0x20);
	dsi_dcs_write_seq(dsi, 0xff, 0x10);
	dsi_dcs_write_seq(dsi, 0xfb, 0x01);
	dsi_dcs_write_seq(dsi, 0xc0, 0x03);
